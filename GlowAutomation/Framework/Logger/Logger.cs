...
namespace GlowAutomation.Framework
{
    public sealed class Logger
    {
        ...
        public static string LogDelimiterString = "::";
        private static readonly bool s_logSteps = true;
        ...
        {
            string layout = "${date:format=yyyy-MM-dd HH\\:mm\\:ss} ${level:uppercase=true} - ${message}";
        ...
        private void LogDelimiter(string msg)
        {
            if (s_logSteps)
            {
                Info(string.Format("......::[ {0} ]::......", msg));
            }
        }

        public void Step(int step)
        {
            LogDelimiter("Step " + step);
        }
    }
}